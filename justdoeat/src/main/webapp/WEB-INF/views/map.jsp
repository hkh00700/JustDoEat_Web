        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="서구청 맛집" id="keyword" size="15"> 
...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5b7262693dcf80bf66b95325ad7138f9&libraries=services"></script>
<script>
